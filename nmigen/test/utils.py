...
class FHDLTestCase(unittest.TestCase):
    ...
    def assertFormal(self, spec, mode="bmc", depth=1):
        ...
        spec_name = "{}_{}".format(os.path.basename(spec_root).replace("test_", "spec_"), caller.name.replace("test_", ""))
        ...
        {rtlil}
        """
        ).format(mode=mode, depth=depth, script=script, rtlil=rtlil.convert(Fragment.get(spec, platform="formal")))
